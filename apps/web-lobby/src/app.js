...
import { initHandFit, fitAllHands } from './net/hand-layout.js?v=play9ui2c';
import { tableActsFromOnlineRoom } from './net/ddz-table-acts.js?v=play9ui2c';
import { evaluatePlaySelection } from './net/ddz-play-validate.js?v=play9ui2c';
import { shouldIgnoreMouseAfterTouch, isTapGesture } from './net/ddz-hand-touch.js?v=play9ui2c';
import { initTableOrientation, expandTelegramTable, syncTableStageLandscape, syncViewportHeight } from './net/table-orient.js?v=play9ui2c';
...
function friendInviteUrl(roomId) {
  ...
  // play9ui2c: startapp=t_<roomKey> deep link
...
function bindFriendDualEnter() {
  ...
  // play9ui2c: TG invite deep link — start_param / tgWebAppStartParam / startapp
...
function renderJjSettleHud() {
  ...
  if (top) {
    ...
    // play9ui2c: keep pill icons; structure-only xp when no career meter
    if (xp) {
...
function _renderGameBody() {
  ...
  // play9ui2c: 「自动出牌中」 banner when trustee (UI only; no 赖子)
