/**
 * play9fin6c — lobby activity / daily supply entry
...
test('cache play9fin6c', () => {
  ...
  assert.match(html, /lobby-ia\.css\?v=play9fin6c/);
...
test('docs/qa play9fin6c present', () => {
  ...
  assert.equal(existsSync(join(root, '../../docs/qa/play9fin6c/report.json')), true);
});
