...
test('play9fin1a cache bust on CSS + app.js', () => {
  assert.match(html, /app\.js\?v=play9fin1a/);
  assert.match(html, /hand-fit\.css\?v=play9fin1a/);
  assert.match(html, /table-landscape\.css\?v=play9fin1a/);
  assert.match(html, /jj-table\.css\?v=play9fin1a/);
  assert.match(html, /jj-mahjong\.css\?v=play9fin1a/);
  assert.match(html, /niuniu\.css\?v=play9fin1a/);
...
test('play9fin1a prefers viewportStableHeight over innerHeight', () => {
  assert.match(orientSrc, /resolveTelegramViewportHeight/);
